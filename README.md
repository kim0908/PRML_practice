...
# 1.Regression
  ...
  <img src="Regression/pic/3a.png" width="700"><img src="Regression/pic/3b.png" width="700"><br/>
  
  (4) Bayesian linear regression (Sigmoid basis functions)
      
      Compare the performance with different data size N
      
<img src="Regression/pic/3c_1.png" width="700">
<img src="Regression/pic/3c_2.png" width="700"><br/>
...
<img src="/GMM with Kmeans and EM/segment_result/img1_K=2.jpg" width="150"><img src="/GMM with Kmeans and EM/segment_result/img1_K=3.jpg" width="150"><img src="/GMM with Kmeans and EM/segment_result/img1_K=5.jpg" width="150"><img src="/GMM with Kmeans and EM/segment_result/img1_K=10.jpg" width="150"><img src="/GMM with Kmeans and EM/segment_result/img1_K=20.jpg" width="150"><br>

<img src="/GMM with Kmeans and EM/segment_result/img2_K=2.jpg" width="150"><img src="/GMM with Kmeans and EM/segment_result/img2_K=3.jpg" width="150"><img src="/GMM with Kmeans and EM/segment_result/img2_K=5.jpg" width="150"><img src="/GMM with Kmeans and EM/segment_result/img2_K=10.jpg" width="150"><img src="/GMM with Kmeans and EM/segment_result/img2_K=20.jpg" width="150"><br>

<img src="/GMM with Kmeans and EM/segment_result/img3_K=2.jpg" width="150"><img src="/GMM with Kmeans and EM/segment_result/img3_K=3.jpg" width="150"><img src="/GMM with Kmeans and EM/segment_result/img3_K=5.jpg" width="150"><img src="/GMM with Kmeans and EM/segment_result/img3_K=10.jpg" width="150"><img src="/GMM with Kmeans and EM/segment_result/img3_K=20.jpg" width="150"><br>
